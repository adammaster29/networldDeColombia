...
const Acerca_de = () => {
    return (
        <div className='containerAcerca' ><br /><br />
            <h1 id='acerca' className='titulo' >Acerca De Networld Colombia S.A.S</h1> 
            <div className='contenedor-padre-acerca'>
                <img src='/img/logo.jpeg' alt='' className='img-acerca'/>
               
                <div className='text-acerca'>
                    <h5  className=' tituloGeneral'><span className='span-N'>N</span>ETWORLD DE COLOMBIA S.A.S</h5><br />
