...
const BeneficioDeCliente = () => {
    return (
        <div className='containerpadre'>  <br />
         <h1 id='blog' className="titulo">Trabajamos En Beneficio De Nuestros Clientes</h1><br /><br />
            ...
            <div className="containerCotizacion">
                    <h3 className='notranslate'>Bienvenidos a Nuestra Empresa NETWORLD DE COLOMBIA S.A.S</h3>
